...
def create_dataset(directory_path, processed_df_output_path):
...
def finalize_dataset(processed_df):
    ...
    # infer issue_title, scraped_editors, issue_text, issue_link by grouping by volume and issue
